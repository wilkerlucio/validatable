...
The i18n support work as ActiveRecord validations i18n, you can check a good doc at Rails Guides: http://guides.rubyonrails.org/i18n.html#translations-for-active-record-models

Currently it isn't supporting all ActiveRecord translations, you can check possible values at pirate language sample in tests.
